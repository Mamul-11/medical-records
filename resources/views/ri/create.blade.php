...
<section class="content">
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title">Tambah Riwayat Rawat Inap</h3>
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <form action="{{ route('store_ranap', $no_rm) }}" method="post" class="mb-5">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="date"
                                        class="form-control form-control-border border-width-2 @error('tgl_masuk') is-invalid @enderror"
                                        data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy"
                                        data-mask inputmode="numeric" name="tgl_masuk" id="tgl_masuk"
                                        value="{{ old('tgl_masuk') }}" autofocus required>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="date" class="form-control form-control-border border-width-2 @error('tgl_keluar') is-invalid @enderror" data-inputmask-alias="datetime"
                                        ...
                                        id="tgl_keluar" value="{{ old('tgl_keluar') }}">
                                </div>
                                <div class="text-danger">
                                    @error('tgl_keluar')
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <textarea
                                    ...
                                    rows="3" placeholder="Masukan keluhan pasien" id="keluhan" name="keluhan"
                            ...
                            <div class="form-group">
                                ...
                                <textarea
                                    ...
                                    rows="3" placeholder="Masukan diagnosa pasien" id="diagnosa" name="diagnosa"
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <select
                                    ...
                                    id="ket" name="ket" required>
                                    <option value="">Select your option</option>
                                    <option value="Sakit" {{ old('ket') == 'Sakit' ? 'selected' : '' }}>Sakit</option>
                                    <option value="Meninggal" {{ old('ket') == 'Meninggal' ? 'selected' : '' }}>
                                        Meninggal</option>
                                    <option value="Rujuk" {{ old('ket') == 'Rujuk' ? 'selected' : '' }}>Rujuk</option>
                                    <option value="Atas permintaan pasien"
                                        {{ old('ket') == 'Atas permintaan pasien' ? 'selected' : '' }}>Atas permintaan
                                        pasien</option>
                                </select>
                                <div class="text-danger">
                                    @error('ket')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    id="biaya" name="biaya" value="{{ old('biaya') }}" placeholder="Masukan nominal Pembayaran pasien">
                                <div class="text-danger">
                                    @error('biaya')
                                    {{ $message }}
                                    @enderror
