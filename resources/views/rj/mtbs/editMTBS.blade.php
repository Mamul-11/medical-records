...
<div class="row mb-2">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Edit Riwayat Rawat Jalan MTBS</li>
        </ol>
@endsection
...
<section class="content">
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title">Edit Riwayat Rawat Jalan MTBS</h3>
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <form action="{{ route('update_mtbs', ['id' => $rajal -> id, 'pasien_id' => $rajal -> pasien_id]) }}" method="post" class="mb-5">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                name="diagnosa">{{ old('diagnosa', $rajal->diagnosa) }}</textarea>
                                <div class="text-danger">
                                    @error('diagnosa')
                                    {{ $message }}
                                    @enderror
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                name="terapi">{{ old('terapi', $rajal->terapi) }}</textarea>
                                <div class="text-danger">
                                    @error('terapi')
                                    {{ $message }}
                                    @enderror
