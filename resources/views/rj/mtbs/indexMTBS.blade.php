...
@section('body-title')
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Riwayat Rawat Jalan MTBS</li>
        </ol>
@endsection
...
<section class="content">
        ...
        <div class="card-body">
            <div class="card">
                <div class="card-header">
                    ...
                    <h4>No. Rekam Medis : <strong>{{ $pasien->no_rm }}</strong>
                </div>
    ...
    <div class="card card-secondary card-outline">
        <div class="card-header">
            <h3 class="card-title">Riwayat Rawat Jalan MTBS</h3>
            <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                    <i class="fas fa-minus"></i>
                </button>
        ...
        <div class="card-body">
            <div class="d-flex flex-row bd-highlight mb-3">
                <a href="{{ route('create_mtbs', $pasien->no_rm) }}" class=" nav-link">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-lightblue">
                            <div class="card-header">
                                <button type="button" class="btn btn-dark btn-sm"><a href="/rawat_jalan/mtbs/{{ $pasien->no_rm }}/index">Refresh</a></button>
                                <div class="card-tools">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start">
                                                    ...
                                                    <div class="btn">
                                                        <a href="{{ route('edit_mtbs', ['id' => $rajal -> id, 'pasien_id' => $rajal -> pasien_id]) }}">
                                                            <button type="button"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-danger">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Hapus data riwayat Rawat Jalan MTBS</h4>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="py-3 text-center">
                                                            <p class="heading mt-3">Apakah anda yakin ingin menghapus riwayat
                                                                tanggal "{{ $rajal->tgl_masuk}}" dengan petugas "{{ $rajal->user1 }}" ?</p> 
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer justify-content-between">
                                                        <form action="{{ route('destroy_mtbs', ['id' => $rajal -> id, 'pasien_id' => $rajal -> pasien_id]) }}"
