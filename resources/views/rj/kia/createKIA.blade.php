...
@section('body-title')
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Tambah Riwayat Rawat jalan KIA</li>
        </ol>
@endsection
...
<section class="content">
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title">Tambah Riwayat Rawat Jalan KIA</h3>
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <form action="{{ route('store_kia', $no_rm) }}" method="post" class="mb-5">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-success swalDefaultSuccess">
                        create data riwayat KIA pasien
                    </button>
                </div>
            </form>
        </div>
