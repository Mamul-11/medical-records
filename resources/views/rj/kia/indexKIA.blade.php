...
<section class="content">
    ...
    <div class="card card-secondary card-outline">
        <div class="card-header">
            <h3 class="card-title">Riwayat Rawat Jalan KIA</h3>
            <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                    <i class="fas fa-minus"></i>
                </button>
        ...
        <div class="card-body">
            <div class="d-flex flex-row bd-highlight mb-3">
                <a href="{{ route('create_kia', $pasien->no_rm) }}" class=" nav-link">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-lightblue">
                            <div class="card-header">
                                <button type="button" class="btn btn-dark btn-sm"><a href="/rawat_jalan/kia/{{ $pasien->no_rm }}/index">Refresh</a></button>
                                <div class="card-tools">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start">
                                                    ...
                                                    <div class="btn">
                                                        <a
                                                            href="{{ route('edit_kia', ['id' => $rajal -> id, 'pasien_id' => $rajal -> pasien_id]) }}">
                                                            <button type="button"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-danger">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Hapus data riwayat Rawat Jalan KIA</h4>
                                                    ...
                                                    <div class="modal-footer justify-content-between">
                                                        <form action="{{ route('destroy_kia', ['id' => $rajal -> id, 'pasien_id' => $rajal -> pasien_id]) }}"
