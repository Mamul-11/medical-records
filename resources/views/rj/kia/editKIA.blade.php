...
@section('body-title')
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Edit Riwayat Rawat Jalan-KIA</li>
        </ol>
@endsection
...
<section class="content">
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title">Edit Riwayat Rawat Jalan KIA</h3>
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <form action="{{ route('update_kia', ['id' => $rajal -> id, 'pasien_id' => $rajal -> pasien_id]) }}" method="post" class="mb-5">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea
                                    ...
                                    name="keluhan" required>{{ old('keluhan', $rajal->keluhan) }}</textarea>
                                <div class="text-danger">
                                    @error('keluhan')
                                    {{ $message }}
                                    @enderror
