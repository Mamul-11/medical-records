...
<div class="row mb-2">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Export Riwayat Rawat Jalan KIA</li>
        </ol>
@endsection
...
<section class="content">
    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title">Export Riwayat Rawat Jalan KIA</h3>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('show_kia') }}" method="GET">
                            <div class="card-header">
