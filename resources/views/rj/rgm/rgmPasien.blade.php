...
@section('body-title')
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Data Pasien Rawat Jalan RGM</li>
        </ol>
@endsection
    ...
    <div class="card card-primary card-outline">
        ...
        <div class="card-body">
            <div class="d-flex flex-row bd-highlight">
                <a href="/rawat_jalan/rgm/export" class=" nav-link">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-success">
                        <div class="card-header">
                            <button type="button" class="btn btn-dark btn-sm"><a href="/rawat_jalan/rpu">Refresh</a></button>
                            <div class="card-tools">
