...
@section('body-title')
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Tambah Riwayat Rawat Jalan RGM</li>
        </ol>
@endsection
...
<section class="content">
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title">Tambah Riwayat Rawat Jalan RGM</h3>
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <form action="{{ route('store_rgm', $no_rm) }}" method="post" class="mb-5">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
