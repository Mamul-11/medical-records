...
@section('body-title')
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Export Riwayat Rawat Jalan RGM</li>
        </ol>
@endsection
...
<section class="content">
    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title">Export Riwayat Rawat Jalan RGM</h3>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('show_rgm') }}" method="GET">
                            <div class="card-header">
