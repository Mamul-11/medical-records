...
<div class="row mb-2">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Edit Riwayat Ruang Gawat Darurat</li>
        </ol>
@endsection
...
<section class="content">
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title">Edit Riwayat Ruang Gawat Darurat</h3>
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <form action="{{ route('update_ragad', ['id' => $ragad -> id, 'pasien_id' => $ragad -> pasien_id]) }}" method="post" class="mb-5">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="date" class="form-control form-control-border border-width-2 @error('tgl_masuk') is-invalid @enderror" data-inputmask-alias="datetime"
                                        ...
                                        id="tgl_masuk" value="{{ old('tgl_masuk', $ragad->tgl_masuk) }}" required>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('jaminan', $ragad->jaminan) }}" autofocus required>
                                <div class="text-danger">
                                    @error('jaminan')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('tekanan', $ragad->tekanan) }}" required>
                                <div class="text-danger">
                                    @error('tekanan')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    id="bb" name="bb" value="{{ old('bb', $ragad->bb) }}" placeholder="Masukan berat badan pasien">
                                <div class="text-danger">
                                    @error('bb')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <textarea
                                    ...
                                    name="keluhan" required>{{ old('keluhan', $ragad->keluhan) }}</textarea>
                                <div class="text-danger">
                                    @error('keluhan')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                name="diagnosa" required>{{ old('diagnosa', $ragad->diagnosa) }}</textarea>
                                <div class="text-danger">
                                    @error('diagnosa')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                name="terapi" required>{{ old('terapi', $ragad->terapi) }}</textarea>
                                <div class="text-danger">
                                    @error('terapi')
                                    {{ $message }}
                                    @enderror
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select
                                    ...
                                    <option value="Ya" {{ old('tindakan', $ragad->tindakan) == 'Ya' ? 'selected' : '' }}>Ya</option>
                                    <option value="Tidak" {{ old('tindakan', $ragad->tindakan) == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                                </select>
                                <div class="text-danger">
                                    @error('tindakan')
                                    {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <select
                                    ...
                                    <option value="">Select your option</option>
                                    <option value="Ya" {{ old('ic',$ragad->ic) == 'Ya' ? 'selected' : '' }}>Ya</option>
                                    <option value="Tidak" {{ old('ic', $ragad->ic) == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                                </select>
                                <div class="text-danger">
                                    @error('ic')
                                    {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <select
                                    ...
                                    <option value="">Select your option</option>
                                    <option value="Ya" {{ old('rujuk', $ragad->rujuk) == 'Ya' ? 'selected' : '' }}>Ya</option>
                                    <option value="Tidak" {{ old('rujuk', $ragad->rujuk) == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                                </select>
                                <div class="text-danger">
                                    @error('rujuk')
                                    {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('rs_rujuk', $ragad->rs_rujuk) }}">
                                <div class="text-danger">
                                    @error('rs_rujuk')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <textarea
                                    ...
                                    name="monitoring_rujuk">{{ old('monitoring_rujuk', $ragad->monitoring_rujuk) }}</textarea>
                                <div class="text-danger">
                            ...
                            <div class=" form-group">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4 select-success select2-hidden-accessible"
                                        ...
                                        @if(old('user1', $ragad->user1) == $user->nama)
                            ...
                            <div class=" form-group">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4 select-success select2-hidden-accessible"
                                        ...
                                        <option value="">Select your option</option>
                                        @foreach ($users as $user)
                                        @if(old('user2', $ragad->user2) == $user->nama)
                                        <option value="{{ $user->nama }}" selected>{{ $user->nama }}</option>
                                        @else
                                        <option value="{{ $user->nama }}">{{ $user->nama }}</option>
                                        @endif
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2bs4 select-success select2-hidden-accessible"
                                    ...
                                    <option value="">Select your option</option>
                                    @foreach ($users as $user)
                                    @if(old('user3', $ragad->user3) == $user->nama)
                                    <option value="{{ $user->nama }}" selected>{{ $user->nama }}</option>
                                    @else
                                    <option value="{{ $user->nama }}">{{ $user->nama }}</option>
                                    @endif
